package com.hpedu.test.HttpClientTest.test;
...
public class HttpClientTest {
    ...
    public void testGet() throws Exception {
        MyHttpResponse result = HttpClientUtils.doGet("http://127.0.0.1:8080/hello/get");
    ...
    public void testGetWithParam() throws Exception {
        ...
        MyHttpResponse result = HttpClientUtils.doGet("http://127.0.0.1:8080/hello/getWithParam", params);
        System.out.println(result);
    }
    ...
    public void testPost() throws Exception {
        ...
        MyHttpResponse result = HttpClientUtils.doPost("http://127.0.0.1:8080/hello/post", headers, null);
        System.out.println(result);
    }
    ...
    public void testPostWithParam() throws Exception {
        ...
        params.put("code", "0");
        params.put("message", "helloworld");
        MyHttpResponse result = HttpClientUtils.doPost("http://127.0.0.1:8080/hello/postWithParam", params);
        System.out.println(result);
    }

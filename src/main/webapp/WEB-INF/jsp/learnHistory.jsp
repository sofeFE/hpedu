...
<div class="content"   style="width:100%;padding:0px;overflow-y:hidden; " >
	<div class="classification-content video-chapter" style="margin:0px;">			
		...
		<div class="classification-content-every thisv2" onclick="openVideo('${gv.vid}','${gv.vname}','${gv.vctype}','${gv.isMore==null?0:gv.isMore}')">
			<a>
...
function pageSize(num){
	window.location.href="${pageContext.request.contextPath}/learnHistory.html?pageNo="+num;
}

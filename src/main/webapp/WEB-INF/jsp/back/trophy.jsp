...
$(function(){
	...
	window.location.href="${pageContext.request.contextPath}back-authc/deleteTrophy?id="+id;
	});
...
function changeSort(type,id){
	 ...
	 if(change_tr_id){
		 ...
		 //修改库顺序
		 $.post("${pageContext.request.contextPath}/back-authc/updatStuSort",{id1:id,sort1:new_sort,id2:change_id,sort2:cur_sort},function(res){
